...
import { PortofolioModel } from "../../../../data/models/portofolio_model";
type BioProps = {
  portofolio?: PortofolioModel;
  phone: string;
};
function IllustratorsBioSection({ portofolio, phone }: BioProps) {
  return (
    <>
      <div className="my-5">
...
export default IllustratorsBioSection;
