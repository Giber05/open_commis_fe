...
function DetailProduk() {
  ...
  useEffect(() => {
    if (title.length >= 25 && isMobile === true) setEllipsis(true);
  }, [isMobile]);
  return (
   <Card
     ...
     <Typography className='text-center text-lg sm:text-lg lg:text-lg font-bold'>Detail Produk</Typography>
      <Divider className="my-2" />
       <Row justify='space-between'>
            ...
            <Col className="text-base leading-10" >
                <Col>
                    <Typography.Text className="text-sm  sm:text-sm lg:text-lg font-bold">{ellipsis ? `${title?.substring(0, 15)}... ` : title}</Typography.Text>
                </Col>
                <Col>
                    <Typography.Text className="text-lg font-bold text-right"> Rp100.000</Typography.Text>
                </Col>
            </Col>
      </Row>
