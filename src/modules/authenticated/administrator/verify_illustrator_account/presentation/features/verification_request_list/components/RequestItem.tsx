...
function RequestItem({ illustrator }: IllustratorProps) {
  return (
    <div className="w-3/4 md:w-3/4 lg:w-full xl:w-full bg-gradient-to-tr from-gray-100 to-gray-200 rounded-xl  shadow-md p-4 mx-auto h-48 ">
      <div>
        <div className="flex flex-wrap border-b border-gray-200 ">
          {illustrator.verified ? (
            ...
            <div className="bg-gradient-to-tr from-red-300 to-reject -mt-10 mb-4 rounded-full text-white grid items-center w-24 h-24  justify-center shadow-lg-orange">
              <Avatar size={{ xs: 84, sm: 84, md: 84, lg: 84, xl: 100, xxl: 100 }} shape="circle" className="" src={illustrator.profilePicture ?? AssetConstants.imageURL + "placeholder/profile_placeholder.png"} />
            </div>
          )}
