...
function WithdrawalPage() {
  ...
  const { isLoadingBalance,withdrawBalance } = useWithdrawalHandler();
  return (
    <div className="bg-white">
      <div className="max-w-2xl mx-auto py-3 px-4 sm:py-6 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <div className="w-11/12 sm:w-5/6 md:w-3/4 xl:w-1/2 m-auto text-center ">
          <Form layout="vertical" className="text-sm font-semibold" name="withdraw-form" validateMessages={validateMessages} 
          onFinish={withdrawBalance}>
            <FormItem name="destination" label="Metode Penarikan">
              <Select
            ...
            <FormItem name="account_number" label="No. Akun/Rekening">
            ...
            <FormItem rules={[{ type: "number", min: 50000, max: illustratorsBalance?.balance, required: true }]} name="amount" label="Jumlah Penarikan">
              <InputNumber  style={{
                  width: "100%",
                }}  className="form-style-blue" placeholder="Masukan jumlah yang akan ditarik" />
            </FormItem>
